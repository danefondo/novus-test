<template>
  <div>
    ...
    <ManVSCover />
    <ManVSHeader />
    <ManVSSection v-for="(section, index) in sections" :index="index" :key="section.title" :maxDesignWidth="maxDesignWidth" :minDesignWidth="minDesignWidth" :section="section" />
    <ManVSCTA />
    <ManVSFooter />
  </div>
</template>
